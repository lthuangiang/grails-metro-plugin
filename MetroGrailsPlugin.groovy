...
'''
    ...
    def doWithSpring = {
        ...
        def xml = new StreamingMarkupBuilder().bind {
            mkp.xmlDeclaration()
            mkp.declareNamespace(wss: "http://jax-ws.dev.java.net/spring/servlet")
            mkp.declareNamespace(ws: "http://jax-ws.dev.java.net/spring/core")
            mkp.declareNamespace(sp: "http://www.springframework.org/schema/beans")
            mkp.declareNamespace(xsi: "http://www.w3.org/2001/XMLSchema-instance")

            String classDir = "target/classes" //"${userHome}/.grails/${grailsVersion}/projects/${appName}/classes"
            new File(classDir).mkdir()
            String sourceDir = "target/generated-java-source"
            ...
            sp.beans('xsi:schemaLocation': "http://jax-ws.dev.java.net/spring/core http://jax-ws.dev.java.net/spring/core.xsd http://jax-ws.dev.java.net/spring/servlet http://jax-ws.dev.java.net/spring/servlet.xsd http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans-2.0.xsd") {
                def clazz = application?.allClasses as List
                clazz.unique().each { cl ->
...
//
    ...
    def processEndpoint(endpoint, servlets, servletMappings) {
        ...
        println "Processing web.xml for endpoint: " + name + " | " + impl + " | " + url
